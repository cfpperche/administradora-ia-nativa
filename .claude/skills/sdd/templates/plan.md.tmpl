...
_Drafted from `spec.md` on {{DATE}}. Update this file if implementation reveals the plan is wrong; do NOT silently diverge._
...
_Sources consulted (docs, blog posts, code references) that informed this plan. Satisfies `.claude/rules/research-before-proposing.md`._
