#!/usr/bin/env bash
# .claude/tests/monorepo-stack-detect/run-all.sh
# Orchestrator for spec-015 scenarios. Runs every NN-*.sh in lex order and
...
printf '\n=== monorepo-stack-detect scenario results ===\n'
printf '%s\n' "$results"
printf '==============================================\n'
