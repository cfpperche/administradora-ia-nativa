#!/usr/bin/env bash
# .claude/tests/parallel-edit-validation/run-all.sh
# Orchestrator for spec-067 scenarios. Runs every NN-*.sh in lex order and
...
printf '\n=== parallel-edit-validation scenario results ===\n'
printf '%s\n' "$results"
printf '=================================================\n'
